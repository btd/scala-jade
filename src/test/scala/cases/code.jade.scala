  ...
  "code.jade" should {
    ...
    object code_html {
      ...
      def apply() = {
        ...
        builder ++= ("\n")
        builder ++= ("")
        builder ++= ("<" + "p" + falsy(null).map(v => " " + "foo" + "=" + "'" + escape(v) + "'").getOrElse("") + ">")
        builder ++= ("</" + "p" + ">")
        builder ++= ("\n")
        builder ++= ("")
        builder ++= ("<" + "p" + falsy(None).map(v => " " + "foo" + "=" + "'" + escape(v) + "'").getOrElse("") + ">")
        builder ++= ("</" + "p" + ">")
        builder ++= ("\n")
        builder ++= ("")
        builder ++= ("<" + "p" + " " + "foo" + "=" + """""""" + ">")
        ...
        builder ++= ("\n")
        builder ++= ("")
        builder ++= ("<" + "p" + falsy(0).map(v => " " + "foo" + "=" + "'" + escape(v) + "'").getOrElse("") + ">")
        builder ++= ("</" + "p" + ">")
        builder ++= ("\n")
        builder ++= ("")
        builder ++= ("<" + "p" + falsy(false).map(v => " " + "foo" + "=" + "'" + escape(v) + "'").getOrElse("") + ">")
        builder ++= ("</" + "p" + ">")
